...
* The original package name 'az.edu.ada.wm2.spring-boot-security-framework-demo' is invalid and this project uses 'az.edu.ada.wm2.springbootsecurityframeworkdemo' instead.
